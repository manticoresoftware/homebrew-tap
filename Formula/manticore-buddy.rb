...
class ManticoreBuddy < Formula
  ...
  url "https://github.com/manticoresoftware/manticoresearch-buddy.git", branch: "0.3.5", revision: "3db8cfb80855bcc939315db2e415836b18bcf999"
  version "0.3.4-2023020315-3db8cfb"
  license "GPL-2.0"
  version_scheme 1
