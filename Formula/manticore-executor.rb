...
class ManticoreExecutor < Formula
  ...
  if arch.to_s == "x86_64" || arch.to_s == "amd64"
    ...
    url "https://repo.manticoresearch.com/repository/manticoresearch_macos/release/manticore-executor_#{version}-macos-x86_64.tar.gz"
    sha256 "dd152d87b5c48e91b00134397d4aadf8b4a76c85de99597e3ef9738408b3bd87"
  else
    version "1.3.5+250708-6c4be4c"
    url "https://repo.manticoresearch.com/repository/manticoresearch_macos/release/manticore-executor_#{version}-macos-arm64.tar.gz"
